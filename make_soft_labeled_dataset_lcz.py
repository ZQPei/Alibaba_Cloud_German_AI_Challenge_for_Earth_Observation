...
test_a_score_path = osp.join(distill_root, 'score/esb_0.884_a.csv')
test_b_score_path = osp.join(distill_root, 'score_B/esb_0.880_b.csv')
test_2a_score_path = osp.join(distill_root, 'score2_A/esb_0.888_2a.csv')
test_2b_score_path = osp.join(distill_root, 'score2_B/esb_0.892_2b.csv')
