...
class LCZResNet(nn.Module):
	...
	def __init__(self, block, in_planes, layers, num_classes=17, first_kernel=3):
		...
		self.relu = nn.ReLU(inplace=True)
		# self.maxpool = nn.MaxPool2d(kernel_size=3, stride=1, padding=1)  # 16 * 16
...
def resnet10(in_planes=10, num_classes=17, **kwargs):
...
def resnet18(in_planes=10,  num_classes=17, **kwargs):
...
def resnet34(in_planes=10, num_classes=17, **kwargs):
...
def resnet50(in_planes=10, num_classes=17, **kwargs):
...
def resnet101(in_planes=10, num_classes=17, **kwargs):
...
def resnet152(in_planes=10, num_classes=17, **kwargs):
