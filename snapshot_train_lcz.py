...
if __name__ == '__main__':
	...
	# train val 鍚堝苟鍐嶅垝鍒?	# data_source = H5DataSource([train_file, val_file], BATCH_SIZE, split=0.07, seed=SEED)
	...
	# 鍚堝苟鍐嶅垝鍒?val*10 鍏ㄥ湪璁粌鍙?	# data_source = H5DataSource([train_file]+[val_file]*10, BATCH_SIZE, [0.114] + [0]*10, seed=SEED)
	# train_loader = MyDataLoader(data_source.h5fids, data_source.train_indices)
	# val_loader = MyDataLoader(data_source.h5fids, data_source.val_indices)

	# train val 鍥哄畾姣斾緥 1:1
